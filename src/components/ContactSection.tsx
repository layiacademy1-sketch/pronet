            ...
            <div className="bg-white rounded-3xl p-6 sm:p-10 border border-slate-200/90 shadow-sm">
              ...
              {sentSuccess ? (
                <div className="py-12 text-center space-y-4 animate-in fade-in duration-300">
                  ...
                  <h4 className="text-2xl font-black text-slate-900">Message bien transmis !</h4>
                  <p className="text-sm text-slate-600 max-w-md mx-auto">
                    Merci {contactForm.name}, nous avons bien reçu votre prise de contact. Notre
                    équipe vous répondra dans les plus brefs délais à l'adresse {contactForm.email}.
                  </p>
                  <button
                    onClick={() => {
                ...
                <form onSubmit={handleSubmit} noValidate className="space-y-5">
                  ...
                  <button
                    type="submit"
                    disabled={isSending}
                    className="w-full py-3.5 px-6 bg-slate-900 hover:bg-slate-800 text-white rounded-xl font-bold text-sm shadow-md transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-70"
                  >
                    {isSending ? (
                      <>
