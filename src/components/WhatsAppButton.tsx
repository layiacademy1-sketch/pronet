...
export const WhatsAppButton: React.FC = () => {
  ...
  const whatsappUrl = `https://wa.me/33631914671?text=${presetMessage}`;
  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end">
      ...
      <a
        ...
        aria-label="Contacter PRONET sur WhatsApp"
        className="w-14 h-14 rounded-full bg-[#25D366] hover:bg-[#20bd5a] text-white flex items-center justify-center shadow-2xl shadow-emerald-500/40 hover:scale-110 active:scale-95 transition-all duration-300 relative group cursor-pointer"
      >
        {/* Pulsing aura ring */}
        ...
        <span className="hidden group-hover:block absolute right-16 top-1/2 -translate-y-1/2 bg-slate-900 text-white text-xs font-bold px-3 py-1.5 rounded-xl whitespace-nowrap shadow-lg">
